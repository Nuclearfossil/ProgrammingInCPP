# -*- coding: utf-8 -*-
#
# ProgrammingInC++ documentation build configuration file, created by
...
project = u'Programming In C++'
copyright = u'2017, Ash Matheson'
author = u'Ash Matheson'
...
htmlhelp_basename = 'ProgrammingInCdoc'
